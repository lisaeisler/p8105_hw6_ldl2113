...
*Based on my clinical in the delivery room and NICU, I propose that birthweight is predicted by: gestationl age, length, head circumference, smoking status, income, and the number of prior low birthweight babies born to the mother.*
